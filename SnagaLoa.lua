...
function SnagaLoa_ClearAllLists()
          ...
          SnagaLoaText16:SetText("");
          SnagaLoaText17:SetText("");
          SnagaLoaText18:SetText("");
          SnagaLoaText19:SetText("");
          SnagaLoaText20:SetText("");
end 
...
function SnagaLoa_GenerateFirstBox()
	...
	if ( SnagaLoa_TempList[16] ) then
		MF16:Show();
		M16:SetText(SnagaLoa_TempList[16]);
		M16:SetTextColor(SnagaLoa_DecodeColor(SnagaLoa_TempList[16]));
	else
		M16:SetText("");
		MF16:Hide();
	end
	if ( SnagaLoa_TempList[17] ) then
		MF17:Show();
		M17:SetText(SnagaLoa_TempList[17]);
		M17:SetTextColor(SnagaLoa_DecodeColor(SnagaLoa_TempList[17]));
	else
		M17:SetText("");
		MF17:Hide();
	end
	if ( SnagaLoa_TempList[18] ) then
		MF18:Show();
		M18:SetText(SnagaLoa_TempList[18]);
		M18:SetTextColor(SnagaLoa_DecodeColor(SnagaLoa_TempList[18]));
	else
		M18:SetText("");
		MF18:Hide();
	end
	if ( SnagaLoa_TempList[19] ) then
		MF19:Show();
		M19:SetText(SnagaLoa_TempList[1]);
		M19:SetTextColor(SnagaLoa_DecodeColor(SnagaLoa_TempList[19]));
	else
		M19:SetText("");
		MF19:Hide();
	end
	if ( SnagaLoa_TempList[20] ) then
		MF20:Show();
		M20:SetText(SnagaLoa_TempList[20]);
		M20:SetTextColor(SnagaLoa_DecodeColor(SnagaLoa_TempList[20]));
	else
		M20:SetText("");
		MF20:Hide();
	end
...
function SnagaLoa_GenerateBox(typeok)
	...
	if ( SnagaLoa_NamesSave[16] ) then
		MF16:Show();
		M16:SetText(SnagaLoa_NamesSave[16]);
		M16:SetTextColor(SnagaLoa_DecodeColor(SnagaLoa_NamesSave[16]));
	else
		M16:SetText("");
		MF16:Hide();
	end
	if ( SnagaLoa_NamesSave[17] ) then
		MF17:Show();
		M17:SetText(SnagaLoa_NamesSave[17]);
		M17:SetTextColor(SnagaLoa_DecodeColor(SnagaLoa_NamesSave[17]));
	else
		M17:SetText("");
		MF17:Hide();
	end
	if ( SnagaLoa_NamesSave[18] ) then
		MF18:Show();
		M18:SetText(SnagaLoa_NamesSave[18]);
		M18:SetTextColor(SnagaLoa_DecodeColor(SnagaLoa_NamesSave[18]));
	else
		M18:SetText("");
		MF18:Hide();
	end
	if ( SnagaLoa_NamesSave[19] ) then
		MF19:Show();
		M19:SetText(SnagaLoa_NamesSave[19]);
		M19:SetTextColor(SnagaLoa_DecodeColor(SnagaLoa_NamesSave[19]));
	else
		M19:SetText("");
		MF19:Hide();
	end
	if ( SnagaLoa_NamesSave[20] ) then
		MF20:Show();
		M20:SetText(SnagaLoa_NamesSave[20]);
		M20:SetTextColor(SnagaLoa_DecodeColor(SnagaLoa_NamesSave[20]));
	else
		M20:SetText("");
		MF20:Hide();
	end
...
function SnagaLoa_UpdateStatus()
	if ( SnagaLoa_Names[1] ) then
		...
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[1]) ) then
			...
			elseif ( UnitClass(SnagaLoa_RaidIds[1]) == "Paladin" ) then
				SnagaLoaText1:SetTextColor(1,0.62,0.78,1);
			else 
				SnagaLoaText1:SetTextColor(0,0.54,0.87,1);
			end
		end	
	end
	if ( SnagaLoa_Names[2] ) then
		...
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[2]) ) then
			...
			elseif ( UnitClass(SnagaLoa_RaidIds[2]) == "Paladin" ) then
				SnagaLoaText2:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText2:SetTextColor(0,0.54,0.87,1);
			end
		end	
	end
	if ( SnagaLoa_Names[3] ) then
		...
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[3]) ) then
			...
			elseif ( UnitClass(SnagaLoa_RaidIds[3]) == "Paladin" ) then
				SnagaLoaText3:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText3:SetTextColor(0,0.54,0.87,1);
			end
		end	
	end
	if ( SnagaLoa_Names[4] ) then
		...
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[4]) ) then
			...
			elseif ( UnitClass(SnagaLoa_RaidIds[4]) == "Paladin" ) then
				SnagaLoaText4:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText4:SetTextColor(0,0.54,0.87,1);
			end
		end	
	end
	if ( SnagaLoa_Names[5] ) then
		...
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[5]) ) then
			...
			elseif ( UnitClass(SnagaLoa_RaidIds[5]) == "Paladin" ) then
				SnagaLoaText5:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText5:SetTextColor(0,0.54,0.87,1);
			end
		end	
	end
	if ( SnagaLoa_Names[6] ) then
		...
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[6]) ) then
			...
			elseif ( UnitClass(SnagaLoa_RaidIds[6]) == "Paladin" ) then
				SnagaLoaText6:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText6:SetTextColor(0,0.54,0.87,1);
			end
		end	
	end
	if ( SnagaLoa_Names[7] ) then
		...
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[7]) ) then
			...
			elseif ( UnitClass(SnagaLoa_RaidIds[7]) == "Paladin" ) then
				SnagaLoaText7:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText7:SetTextColor(0,0.54,0.87,1);
			end
		end	
	end
	if ( SnagaLoa_Names[8] ) then
		...
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[8]) ) then
			...
			elseif ( UnitClass(SnagaLoa_RaidIds[8]) == "Paladin" ) then
				SnagaLoaText8:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText8:SetTextColor(0,0.54,0.87,1);
			end
		end	
	end
	if ( SnagaLoa_Names[9] ) then
		...
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[9]) ) then
			...
			elseif ( UnitClass(SnagaLoa_RaidIds[9]) == "Paladin" ) then
				SnagaLoaText9:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText9:SetTextColor(0,0.54,0.87,1);
			end
		end	
	end
	if ( SnagaLoa_Names[10] ) then
		...
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[10]) ) then
			...
			elseif ( UnitClass(SnagaLoa_RaidIds[10]) == "Paladin" ) then
				SnagaLoaText10:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText10:SetTextColor(0,0.54,0.87,1);
			end
		end	
	end
	if ( SnagaLoa_Names[11] ) then
		...
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[11]) ) then
			...
			elseif ( UnitClass(SnagaLoa_RaidIds[11]) == "Paladin" ) then
				SnagaLoaText11:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText11:SetTextColor(0,0.54,0.87,1);
			end
		end	
	end
	if ( SnagaLoa_Names[12] ) then
		...
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[12]) ) then
			...
			elseif ( UnitClass(SnagaLoa_RaidIds[12]) == "Paladin" ) then
				SnagaLoaText12:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText12:SetTextColor(0,0.54,0.87,1);
			end
		end	
	end
	if ( SnagaLoa_Names[13] ) then
		...
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[13]) ) then
			...
			elseif ( UnitClass(SnagaLoa_RaidIds[13]) == "Paladin" ) then
				SnagaLoaText13:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText13:SetTextColor(0,0.54,0.87,1);
			end
		end	
	end
	if ( SnagaLoa_Names[14] ) then
		...
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[14]) ) then
			...
			elseif ( UnitClass(SnagaLoa_RaidIds[14]) == "Paladin" ) then
				SnagaLoaText14:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText14:SetTextColor(0,0.54,0.87,1);
			end
		end	
	end
	if ( SnagaLoa_Names[15] ) then
		...
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[15]) ) then
			...
			elseif ( UnitClass(SnagaLoa_RaidIds[15]) == "Paladin" ) then
				SnagaLoaText15:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText15:SetTextColor(0,0.54,0.87,1);
			end
		end	
	end
	if ( SnagaLoa_Names[16] ) then
		if ( UnitIsDeadOrGhost(SnagaLoa_RaidIds[16]) ) then
			SnagaLoaText16:SetTextColor(0.4,0.4,0.4,1);
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[16]) ) then
			SnagaLoaText16:SetTextColor(0.7,0,0,1);
		else
			if ( UnitClass(SnagaLoa_RaidIds[16]) == "Priest" ) then
				SnagaLoaText16:SetTextColor(1,1,1,1);
			elseif ( UnitClass(SnagaLoa_RaidIds[16]) == "Druid" ) then
				SnagaLoaText16:SetTextColor(1,0.59,0.14,1);
			elseif ( UnitClass(SnagaLoa_RaidIds[16]) == "Paladin" ) then
				SnagaLoaText16:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText16:SetTextColor(0,0.54,0.87,1);
			end
		end
	end
	if ( SnagaLoa_Names[17] ) then
		if ( UnitIsDeadOrGhost(SnagaLoa_RaidIds[17]) ) then
			SnagaLoaText17:SetTextColor(0.4,0.4,0.4,1);
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[17]) ) then
			SnagaLoaText17:SetTextColor(0.7,0,0,1);
		else
			if ( UnitClass(SnagaLoa_RaidIds[17]) == "Priest" ) then
				SnagaLoaText17:SetTextColor(1,1,1,1);
			elseif ( UnitClass(SnagaLoa_RaidIds[17]) == "Druid" ) then
				SnagaLoaText17:SetTextColor(1,0.59,0.14,1);
			elseif ( UnitClass(SnagaLoa_RaidIds[17]) == "Paladin" ) then
				SnagaLoaText17:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText17:SetTextColor(0,0.54,0.87,1);
			end
		end
	end
	if ( SnagaLoa_Names[18] ) then
		if ( UnitIsDeadOrGhost(SnagaLoa_RaidIds[18]) ) then
			SnagaLoaText18:SetTextColor(0.4,0.4,0.4,1);
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[18]) ) then
			SnagaLoaText18:SetTextColor(0.7,0,0,1);
		else
			if ( UnitClass(SnagaLoa_RaidIds[18]) == "Priest" ) then
				SnagaLoaText18:SetTextColor(1,1,1,1);
			elseif ( UnitClass(SnagaLoa_RaidIds[18]) == "Druid" ) then
				SnagaLoaText18:SetTextColor(1,0.59,0.14,1);
			elseif ( UnitClass(SnagaLoa_RaidIds[18]) == "Paladin" ) then
				SnagaLoaText18:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText18:SetTextColor(0,0.54,0.87,1);
			end
		end
	end
	if ( SnagaLoa_Names[19] ) then
		if ( UnitIsDeadOrGhost(SnagaLoa_RaidIds[19]) ) then
			SnagaLoaText19:SetTextColor(0.4,0.4,0.4,1);
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[19]) ) then
			SnagaLoaText19:SetTextColor(0.7,0,0,1);
		else
			if ( UnitClass(SnagaLoa_RaidIds[19]) == "Priest" ) then
				SnagaLoaText19:SetTextColor(1,1,1,1);
			elseif ( UnitClass(SnagaLoa_RaidIds[19]) == "Druid" ) then
				SnagaLoaText19:SetTextColor(1,0.59,0.14,1);
			elseif ( UnitClass(SnagaLoa_RaidIds[19]) == "Paladin" ) then
				SnagaLoaText19:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText19:SetTextColor(0,0.54,0.87,1);
			end
		end
	end
	if ( SnagaLoa_Names[20] ) then
		if ( UnitIsDeadOrGhost(SnagaLoa_RaidIds[20]) ) then
			SnagaLoaText20:SetTextColor(0.4,0.4,0.4,1);
		elseif ( SnagaLoa_CheckDebuff(SnagaLoa_RaidIds[20]) ) then
			SnagaLoaText20:SetTextColor(0.7,0,0,1);
		else
			if ( UnitClass(SnagaLoa_RaidIds[20]) == "Priest" ) then
				SnagaLoaText20:SetTextColor(1,1,1,1);
			elseif ( UnitClass(SnagaLoa_RaidIds[20]) == "Druid" ) then
				SnagaLoaText20:SetTextColor(1,0.59,0.14,1);
			elseif ( UnitClass(SnagaLoa_RaidIds[20]) == "Paladin" ) then
				SnagaLoaText20:SetTextColor(1,0.62,0.78,1);
			else
				SnagaLoaText20:SetTextColor(0,0.54,0.87,1);
			end
		end
	end
end	
...
function SnagaLoa_DoText()
	...
	if ( SnagaLoa_Names[16] ) then
	SnagaLoaText16:SetText(SnagaLoa_Names[16]);
		if ( UnitClass(SnagaLoa_RaidIds[16]) == "Priest" ) then
			SnagaLoaText16:SetTextColor(1,1,1,1);
		elseif ( UnitClass(SnagaLoa_RaidIds[16]) == "Druid" ) then
			SnagaLoaText16:SetTextColor(1,0.59,0.14,1);
	...
	else SnagaLoaText16:SetText("");
	end
	if ( SnagaLoa_Names[17] ) then
	SnagaLoaText17:SetText(SnagaLoa_Names[17]);
		if ( UnitClass(SnagaLoa_RaidIds[17]) == "Priest" ) then
			SnagaLoaText17:SetTextColor(1,1,1,1);
		elseif ( UnitClass(SnagaLoa_RaidIds[17]) == "Druid" ) then
			SnagaLoaText17:SetTextColor(1,0.59,0.14,1);
	...
	else SnagaLoaText17:SetText("");
	end
	if ( SnagaLoa_Names[18] ) then
	SnagaLoaText18:SetText(SnagaLoa_Names[18]);
		if ( UnitClass(SnagaLoa_RaidIds[18]) == "Priest" ) then
			SnagaLoaText18:SetTextColor(1,1,1,1);
		elseif ( UnitClass(SnagaLoa_RaidIds[18]) == "Druid" ) then
			SnagaLoaText18:SetTextColor(1,0.59,0.14,1);
	...
	else SnagaLoaText18:SetText("");
	end
	if ( SnagaLoa_Names[19] ) then
	SnagaLoaText19:SetText(SnagaLoa_Names[19]);
		if ( UnitClass(SnagaLoa_RaidIds[19]) == "Priest" ) then
			SnagaLoaText19:SetTextColor(1,1,1,1);
		elseif ( UnitClass(SnagaLoa_RaidIds[19]) == "Druid" ) then
			SnagaLoaText19:SetTextColor(1,0.59,0.14,1);
	...
	else SnagaLoaText19:SetText("");
	end
	if ( SnagaLoa_Names[20] ) then
	SnagaLoaText20:SetText(SnagaLoa_Names[20]);
		if ( UnitClass(SnagaLoa_RaidIds[20]) == "Priest" ) then
			SnagaLoaText20:SetTextColor(1,1,1,1);
		elseif ( UnitClass(SnagaLoa_RaidIds[20]) == "Druid" ) then
			SnagaLoaText20:SetTextColor(1,0.59,0.14,1);
